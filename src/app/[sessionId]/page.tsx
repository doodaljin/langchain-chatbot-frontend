              ...
              <div key={index} className="my-4 flex">
                ...
                (message.id[2] === "HumanMessage") ? 
                  ...
                  (message.kwargs.content.includes("oaidall") === true) ? 
                    <div className="flex w-full"><header className="py-2 px-4 mb-2 rounded-md justify-end w-20 "> <Image className="rounded-full w-10 items-center flex" src={profilePic2} alt=""></Image> </header> <p className="text-slate-400 px-4 items-center flex bg-[#E4E6EB] rounded-lg text-black w-fit"><Image src={message.kwargs.content.split("(", 2)[1].split(")")[0]} alt={message.kwargs.content} width={512} height={512}/></p></div> : 
